    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8">
        <div class="main-logo flex items-end h-auto  gap-5 bg-[var(--base-dark-color)] border-[1px] border-[var(--main-accent)] rounded-lg p-6 w-auto">
          <div class="content-wrapper flex justify-start items-center gap-5">
            <img 
              src="/public/img/korzinkaDog.png" 
              class="w-[5vw] bg-white rounded-lg "
              alt="logo"
            >
            <div class="text-logo flex flex-col gap-2 justify-center">
              <strong 
                class="font-extrabold text-2xl text-[var(--logo-sub-color)]"
              >
                korzinka.in.ua
              </strong>
        ...
        <div class="w-full lg:max-w-md max-lg:mx-auto ">
          ...
          <div class="bg-black border-[1px] rounded-3xl p-5">
            <form action="#" class="flex flex-col gap-5">
              <div class="relative">
                <label class="flex  items-center mb-2 text-[var(--main-accent)] text-base font-medium">Email
                </label>
                <input type="text" id="default-search"
                  class="block w-full px-5 py-3 text-lg font-normal shadow-xs text-white bg-[var(--main-dark-color)] border border-gray-400 rounded-full placeholder-gray-400 focus:outline-none leading-relaxed focus-within:border-gray-300"
      ...
      <div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7 pb-16">
        ...
        <div class="relative  text-gray-500 focus-within:text-gray-900 ">
          <div class="absolute inset-y-0 right-6 flex items-center pl-3 pointer-events-none ">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="var(--main-accent)">
