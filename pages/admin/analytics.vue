    ...
    >
      <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div class="mx-auto max-w-5xl">
          ...
          <div class="chart-wrapper grid grid-cols-2 gap-4 mt-4">
            <ActiveUsersChart/>
            <GeographyStats/>
          ...
          <div class="chart-wrapper grid grid-cols-1 gap-4 mt-4">
...
<script setup>
    ...
    import GeographyStats from '~/components/charts/GeographyStats.vue';
    import PeriodComparison from '~/components/charts/PeriodComparison.vue';
    import ProductStats from '~/components/charts/ProductStats.vue';
    import ReturnsStats from '~/components/charts/ReturnsStats.vue';
    import SalesFunnel from '~/components/charts/SalesFunnel.vue';
    import SalesStats from '~/components/charts/SalesStats.vue';
    import UserStats from '~/components/charts/UserStats.vue';
