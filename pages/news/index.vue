<template>
    <div class="section page">
        ...
        <div class="max-w-screen-xl mx-auto pb-5 pt-2 px-5 sm:pb-10 sm:px-10 md:px-16 md:pb-16 relative border-b-[1px] border-[#d9dbe0]">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-12 gap-5">
                ...
                <div class="sm:col-span-5">
                    ...
                    <swiper 
                        ...
                        <swiper-slide
                            ...
                            :style="{ background: gradientColors[Math.floor(Math.random() * gradientColors.length)] }"
                            :key="index"
                        >
                            <a href="#">
                                <div class="text-center overflow-hidden bg-contain bg-no-repeat bg-center"
                                    :style="{ minHeight: '300px', backgroundImage: `url(${item.img})` }"
                ...
                <div class="cards-wrapper sm:col-span-7 grid grid-cols-2 lg:grid-cols-3 gap-5">
                    <div 
                        class="news-card relative flex justify-between flex-col"
                        v-for="(item, index) in showedArr"
                        :key="index"
                    >
                            <div class="img-wrapper flex-1 bg-cover text-center relative overflow-hidden bg-[var(--dark-color)] w-full rounded-tl-[5px] rounded-tr-[5px]"
                        ...
                        <div class="content-block flex-1 px-2 pb-2 border-l-[1px] border-r-[1px] border-b-[1px] border-[var(--primary-color)] flex flex-col justify-between h-full">
                            <h4
                                class="text-gray-900 inline-block font-semibold text-md my-2 hover:text-indigo-600 transition duration-500 ease-in-out">
                                {{ item.title }}
                            </h4>
                            <p class="card-description text-gray-700 text-sm line-clamp-2 text-ellipsis">
                                {{ item.description }}
                            </p>
                            <div class="bottom-group flex items-center justify-between mt-2">
                                <div class="time-posting items-baseline flex justify-between flex-col relative">
                                    <span class="text-[0.7rem] text-[var(--secondary-color)]">
                                        17.12.2024
                                    </span>
                                    <div class="separator w-[1px] h-[0.7rem] bg-[var(--primary-color)]  hidden"/>
                                ...
                                <button class="read-more border-[1px] bg-[var(--dark-color)] text-[var(--light-color)] px-2 py-1 rounded-[5px]">
                                    Детальніше
                                </button>
            ...
            <div class="button-controls w-[100%] flex items-center justify-end mt-5 gap-10">
                        <button 
            ...
            <div class="container">
                ...
                <div class="newsletter-form relative bg-[var(--dark-color)] mx-auto p-5 rounded-lg flex items-center justify-center mt-10 mb-5 h-auto">
                    <div class="img-block relative w-32 h-auto bottom-10">
                        ...
                        <img class="png w-10 absolute bottom-2 -right-4" 
