        ...
        <div class="font-sans tracking-wide max-md:mx-auto">
            <div class="bg-gradient-to-r from-gray-600 via-gray-900 to-gray-900 md:min-h-[600px] grid items-start grid-cols-1 lg:grid-cols-5 md:grid-cols-2">
                    ...
                    <div class="relative h-full flex items-center justify-center lg:min-h-[580px]">
                        ...
                        <div class="flex space-x-4 items-end absolute right-0 max-md:right-4 md:bottom-4 bottom-0">
                            <div class="bg-white w-10 h-10 grid items-center justify-center rounded-full rotate-90 shrink-0 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 fill-[#333] inline" viewBox="0 0 24 24">
                            ...
                            <div class="bg-[#333] w-10 h-10 grid items-center justify-center rounded-full -rotate-90 shrink-0 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 fill-[#fff] inline" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M11.99997 18.1669a2.38 2.38 0 0 1-1.68266-.69733l-9.52-9.52a2.38 2.38 0 1 1 3.36532-3.36532l7.83734 7.83734 7.83734-7.83734a2.38 2.38 0 1 1 3.36532 3.36532l-9.52 9.52a2.38 2.38 0 0 1-1.68266.69734z" clip-rule="evenodd" data-original="#000000"></path>
                                </svg>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-2 bg-gray-100 py-6 px-8 h-full">
                    ...
                    <div class="mt-8">
                        <h3 class="text-lg font-bold text-gray-800">Ціна</h3>
                        <p class="text-gray-800 text-3xl font-bold mt-4">{{productData.price}} грн</p>
                    </div>

                    <div class="mt-8">
                        <h3 class="text-lg font-bold text-gray-800">Оберіть опцію товару</h3>
                    ...
                    <div class="mt-8">
                        <h3 class="text-lg font-bold text-gray-800">Кількість</h3>
                        <div class="flex divide-x border w-max mt-4 rounded overflow-hidden">
                            ...
                            <button type="button" class="bg-transparent w-10 h-9 font-semibold flex items-center justify-center text-gray-800 text-lg">
                                1
                            </button>
                    ...
                    <div class="flex flex-wrap gap-4 mt-8">
                        <button type="button" class="min-w-[200px] px-4 py-3 bg-gray-800 hover:bg-gray-900 text-white text-sm font-semibold rounded">Купити зараз</button>
                        <button type="button" class="min-w-[200px] px-4 py-2.5 border border-gray-800 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded">Додати в кошик</button>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center text-sm text-gray-800 mt-8">
                        ...
                        Безкоштовна доставка при замовленні товару на суму від 2000грн
                    </div>
                </div>
            </div>

            <div class="mt-8 max-w-2xl px-6">
                <h3 class="text-lg font-bold text-gray-800">Параметри товару</h3>
                ...
                <ul class="grid sm:grid-cols-2 gap-3 mt-4">
                    <li class="flex items-center text-sm text-gray-600">
                        ...
                        Вага {{ productData.productWeight }}
                    </li>
                    <li class="flex items-center text-sm text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" class="mr-4 bg-green-500 fill-white rounded-full p-[3px]" viewBox="0 0 24 24">
                            <path d="M9.707 19.121a.997.997 0 0 1-1.414 0l-5.646-5.647a1.5 1.5 0 0 1 0-2.121l.707-.707a1.5 1.5 0 0 1 2.121 0L9 14.171l9.525-9.525a1.5 1.5 0 0 1 2.121 0l.707.707a1.5 1.5 0 0 1 0 2.121z" data-original="#000000" />
                        </svg>
                        Розмір {{ productData.productSize }}
                    </li>
                    <li class="flex items-center text-sm text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" class="mr-4 bg-green-500 fill-white rounded-full p-[3px]" viewBox="0 0 24 24">
                            <path d="M9.707 19.121a.997.997 0 0 1-1.414 0l-5.646-5.647a1.5 1.5 0 0 1 0-2.121l.707-.707a1.5 1.5 0 0 1 2.121 0L9 14.171l9.525-9.525a1.5 1.5 0 0 1 2.121 0l.707.707a1.5 1.5 0 0 1 0 2.121z" data-original="#000000" />
                        </svg>
                        Колір {{ productData.translations.find(tr => tr.language === $i18n.locale).productColor }}
                    </li>
                    <li class="flex items-center text-sm text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" class="mr-4 bg-green-500 fill-white rounded-full p-[3px]" viewBox="0 0 24 24">
                            <path d="M9.707 19.121a.997.997 0 0 1-1.414 0l-5.646-5.647a1.5 1.5 0 0 1 0-2.121l.707-.707a1.5 1.5 0 0 1 2.121 0L9 14.171l9.525-9.525a1.5 1.5 0 0 1 2.121 0l.707.707a1.5 1.5 0 0 1 0 2.121z" data-original="#000000" />
                        </svg>
                        Щильність {{  productData.productDensity }} 
                    </li>
                    <li class="flex items-center text-sm text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" class="mr-4 bg-green-500 fill-white rounded-full p-[3px]" viewBox="0 0 24 24">
                            <path d="M9.707 19.121a.997.997 0 0 1-1.414 0l-5.646-5.647a1.5 1.5 0 0 1 0-2.121l.707-.707a1.5 1.5 0 0 1 2.121 0L9 14.171l9.525-9.525a1.5 1.5 0 0 1 2.121 0l.707.707a1.5 1.5 0 0 1 0 2.121z" data-original="#000000" />
                        </svg>
                        Об'єм {{ productData.productCapacity }}
                    </li>
                    <li class="flex items-center text-sm text-gray-600">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" class="mr-4 bg-green-500 fill-white rounded-full p-[3px]" viewBox="0 0 24 24">
                            <path d="M9.707 19.121a.997.997 0 0 1-1.414 0l-5.646-5.647a1.5 1.5 0 0 1 0-2.121l.707-.707a1.5 1.5 0 0 1 2.121 0L9 14.171l9.525-9.525a1.5 1.5 0 0 1 2.121 0l.707.707a1.5 1.5 0 0 1 0 2.121z" data-original="#000000" />
                ...
                <div class="mt-8">
                    <h3 class="text-lg font-bold text-gray-800">Опис товару</h3>
                    <p class="text-sm text-gray-600 mt-4">
                        {{ productData.translations.find(tr => tr.language === $i18n.locale).productDescription }}
